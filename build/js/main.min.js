...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var mapViewer = function mapViewer() {
    ...
    var layer = L.marker([55.816826, 37.637276], {
  ...
  window.addEventListener('load', function () {
    ...
    var playAudio = function playAudio() {
      var audioPlayer = document.querySelector('.tour-card__audio');
      if (audioPlayer) {
        var playButton = audioPlayer.querySelector('.tour-card__play-button');
