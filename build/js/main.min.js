...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function setTabindexes(slider) {
    var sliderElement = slider.wrapperEl;
    var AllInteractiveElements = sliderElement.querySelectorAll('a, button, iframe');
    ...
    slides.forEach(function (element, index) {
      if (index === slider.activeIndex) {
        var interractivElementInActive = element.querySelectorAll('a, button, iframe');
        interractivElementInActive.forEach(function (item) {
  ...
  var swiperHero = function swiperHero() {
    ...
    if (heroSlider) {
      ...
      heroSlides.forEach(function (element) {
      ...
      var slider = new Swiper('.hero__swiper', {
        // Optional parameters
  ...
  swiperHero();
  var upcomingSlider = function upcomingSlider() {
    var upcomingTourSlider = document.querySelector('.upcoming-tours__slider');
    if (upcomingTourSlider) {
      var upcomingWrapper = document.querySelector('.upcoming-tours__wrapper');
      var upcomingSlides = document.querySelectorAll('.upcoming-tours__slide');
      var upcomingNavigation = document.querySelector('.upcoming-tours__navigation');
      var upcomingTours = document.querySelector('.upcoming-tours');
      ...
      upcomingSlides.forEach(function (element) {
        element.classList.add('swiper-slide');
        element.classList.remove('upcoming-tours__slide');
      });
      var slider = new Swiper('.upcoming-tours__slider', {
        // Default parameters
        loop: false,
        navigation: {
  ...
  upcomingSlider();
  var trainingSlider = function trainingSlider() {
    var trainerSlider = document.querySelector('.training__slider');
    if (trainerSlider) {
      var trainingWrapper = document.querySelector('.training__wrapper');
      var trainingSlides = document.querySelectorAll('.training__slide');
      var trainingNavigation = document.querySelector('.training__navigation');
      ...
      trainingSlides.forEach(function (element) {
        element.classList.add('swiper-slide');
        element.classList.remove('training__slide');
      });
      var slider = new Swiper('.training__slider', {
        // Default parameters
        loop: false,
        navigation: {
  ...
  var reviewsSlider = function reviewsSlider() {
    ...
    if (reviewSlider) {
      ...
      var reviewsNavigation = document.querySelector('.reviews__navigation');
      ...
      reviewsSlides.forEach(function (element) {
        element.classList.add('swiper-slide');
  ...
  var advantagesSlider = function advantagesSlider() {
    ...
    var init;
    function swiperMode() {
      var tablet = window.matchMedia('(min-width: 0px) and (max-width: 1199px)');
    ...
    var advantageSlider = document.querySelector('.advantages__slider');
    if (advantageSlider) {
      var advantagesWrapper = document.querySelector('.advantages__slider-wrapper');
      var advantagesSlides = document.querySelectorAll('.advantages__slide');
      var advantagesNavigation = document.querySelector('.advantages__navigation');
      ...
      advantagesSlides.forEach(function (element) {
        element.classList.add('swiper-slide');
      });
  ...
  var gallerySlider = function gallerySlider() {
    var photo = document.querySelector('.gallery__slider');
    if (photo) {
      var galleryWrapper = document.querySelector('.gallery__slider-wrapper');
      var gallerySlides = document.querySelectorAll('.gallery__slide');
      var galleryNavigation = document.querySelector('.gallery__navigation');
      ...
      gallerySlides.forEach(function (element) {
        element.classList.add('swiper-slide');
  ...
  menu();
  var mapViewer = function mapViewer() {
    var layer;
    var map;
    var ICON = {
      desktopIcon: L.icon({
    ...
    function iconMode() {
      var mobile = window.matchMedia('(min-width: 0px) and (max-width: 769px)');
      var tablet = window.matchMedia('(min-width: 768px) and (max-width: 1199px)');
      var desktop = window.matchMedia('(min-width: 1200px)');
      if (desktop.matches) {
        layer.remove();
        layer = L.marker([55.816826, 37.637276], {
    ...
    if (mapContainer) {
      ...
      var picture = document.querySelector('.contacts__map-container picture');
  ...
  window.addEventListener('load', function () {
    ...
    var playAudio = function playAudio() {
      var audioPlayer = document.querySelectorAll('.tour-card__audio');
      if (audioPlayer.length) {
        audioPlayer.forEach(function (item) {
          var playButton = item.querySelector('.tour-card__play-button');
    ...
    var playVideo = function playVideo() {
      var videoPlayer = document.querySelector('.tour-card__video');
      if (videoPlayer) {
        var playButton = videoPlayer.querySelector('.tour-card__play-button');
        var previewer = videoPlayer.querySelector('picture');
        var source = playButton.getAttribute('href');
        playButton.addEventListener('click', function (evt) {
          evt.preventDefault();
          playButton.style.display = 'none';
          var newIframe = document.createElement('iframe');
